...
import { OsmService } from '../places-list/osm.service';
...
export class MapComponent implements AfterViewInit, OnDestroy {
  ...
  showWelcome = signal(localStorage.getItem('dogly-welcome-seen') !== 'true');
  ...
  private dismissWelcome(): void {
    ...
    localStorage.setItem('dogly-welcome-seen', 'true');
  }
